---
name: P2
description: Database — governed analysis stage, pass 1 of the governance-factory. Run through `gov.py run-stage P2`; never by hand.
---
...
| Inputs | `srs`, `registry-srs` — read from `_state/` |
