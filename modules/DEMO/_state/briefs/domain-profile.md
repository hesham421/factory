# BRIEF — stage `domain-profile` (Domain Profile) · module DEMO · v1 · profile `erp`
...
| Code | Display | Status |
|---|---|---|
| [code] | [display] | IN PROFILE / PROPOSED — add to profile before P-1 |
...
before `P-1` runs. Engines never invent codes.
