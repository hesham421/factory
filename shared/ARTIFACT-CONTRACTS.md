...
#   · count-agrees · required-writer · operation-resolves
contracts:
  - id: C1
...
| `C7` | backend execution plan → split / deliver | `P3.1` | `split` | `backend-execution-plan`, `registry-exec-be` | 20 |
